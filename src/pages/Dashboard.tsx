...
import { AlertTriangle, Plus, Filter, BarChart3, Calendar, Brain, ClockIcon, CheckSquare, UserCheck } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <Button variant="outline" size="sm" onClick={() => navigate('/reports')} className="border-flydubai-blue text-flydubai-blue hover:bg-blue-50">
                View Full Analytics
              </Button>
            </div>
          </div>
      ...
      <div className="flex gap-4 flex-wrap">
        <Button onClick={handleCreateRecoveryPlan} className="flex items-center gap-2 btn-flydubai-primary">
        ...
        <Button 
          variant="outline" 
          onClick={() => navigate('/prediction-dashboard')}
